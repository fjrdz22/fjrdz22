...
I turn raw, messy data into clear business decisions. My toolbelt includes: **Excel + Power Query**, **SQL**, and **Python** (pandas). I focus on building analyses and small ETL systems that stand up in the real world—simple to run, documented, and decision-ready.
...
📫 Reach: fran1data@gmail.com • Location: Houston, Texas (CST)
